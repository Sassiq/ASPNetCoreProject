...
namespace WEB_953502_CHEKHOVICH.Migrations
{
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ComputerGroups", x => x.ComputerGroupId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Computers_ComputerGroups_ComputerGroupId",
                        column: x => x.ComputerGroupId,
                        principalTable: "ComputerGroups",
                        principalColumn: "ComputerGroupId",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Computers_ComputerGroupId",
                table: "Computers",
